...
The effect of $D$ on $Y_{2}$ (again labelled `beta`) is biased in this model with an estimated coefficient of `r round(est2, 3)`.
...
res = replicate(n = 5000L, expr = sim_func())
```
